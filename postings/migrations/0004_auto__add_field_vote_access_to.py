...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.access_to'
        db.add_column(u'postings_vote', 'access_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['postings.Posting']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.access_to'
        db.delete_column(u'postings_vote', 'access_to_id')
